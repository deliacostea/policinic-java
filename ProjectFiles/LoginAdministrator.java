...
public class LoginAdministrator extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		Selectare.setModel(
				new javax.swing.DefaultComboBoxModel<>(new String[] { "Super Administrator", "Administrator" }));
	...
	private void OkActionPerformed(java.awt.event.ActionEvent evt) {
		...
		try {
			...
			ResultSet rs = statement.executeQuery(
					"Select admin.Super_Administrator sp,CNP,Email,Functia,idAngajat from Administrator admin inner join Angajat a using (idAdministrator) inner join utilizator using (idAngajat) where CNP = '"
			...
			if (rs.next()) {
				if (!rs.getString("idAngajat").equals(null)) {
					...
					if (Selectare.getSelectedItem().toString().equals("Super Administrator")
							&& rs.getString("Functia").equals("Administrator") && rs.getString("sp").equals("1")) {
						Super_Administrator ff = new Super_Administrator();
						ff.show();

						dispose();

					} else if (Selectare.getSelectedItem().toString().equals("Administrator")
							&& rs.getString("Functia").equals("Administrator")) {

						Administrator ff = new Administrator();
						ff.show();
