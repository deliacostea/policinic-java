 ...
 * 
 */
public class LoginPacient extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		Inregistrare.setText("Inregistreaza-te");
		...
		jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel1Layout.createSequentialGroup().addGroup(jPanel1Layout
						...
						.addGroup(jPanel1Layout.createSequentialGroup().addGap(106, 106, 106).addComponent(Ok)
								.addGap(38, 38, 38).addComponent(Inregistrare))
		...
		jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel1Layout.createSequentialGroup().addGroup(jPanel1Layout
						...
						.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(Ok).addComponent(Inregistrare))
		...
		try {
			...
			if (rs.next()) {
				if (!rs.getString("Email").equals(null)) {
					...
					if (Selectare.getSelectedItem().toString().equals("Pacient")
							&& rs.getString("Functia").equals("Pacient")) {
						UserParola a = new UserParola(userName, password);
						Pacient in = new Pacient(a);
						in.show();
						dispose();
	...
	private void InregistrareActionPerformed(java.awt.event.ActionEvent evt) {
		// TODO add your handling code here:
		Inregistrare_utilizator in = new Inregistrare_utilizator();
		in.show();
		dispose();
	...
	public static void main(String args[]) {
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				new LoginPacient().setVisible(true);
			}
		});
	}
