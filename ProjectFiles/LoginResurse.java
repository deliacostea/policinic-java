 ...
 * 
 */
public class LoginResurse extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		Selectare.setModel(new javax.swing.DefaultComboBoxModel<>(
				new String[] { "Inspector", "Financiar Contabil", "Receptioner", "Medic", "Asistent Medical" }));
		...
		try {
			...
			if (rs.next()) {
				if (!rs.getString("Email").equals(null)) {
					...
					if (Selectare.getSelectedItem().toString().equals("Inspector")
							&& rs.getString("Functia").equals("Financiar Cont")) {
						rs2 = statement.executeQuery(
								"select inspector FROM policlinica.financiar_cont fc inner join policlinica.angajat a using (idExpert_Financiar_Cont) inner join policlinica.utilizator u using (idAngajat) where CNP = '"
										+ password + "';");

						rs2.next();
						if (rs2.getString("inspector").equals("1")) {
					...
					} else if (Selectare.getSelectedItem().toString().equals("Financiar Contabil")
							&& rs.getString("Functia").equals("Financiar Cont")) {
						Financiar f = new Financiar();
						f.show();

					} else if (Selectare.getSelectedItem().toString().equals("Receptioner")
							&& rs.getString("Functia").equals("Receptioner")) {
						UserParola a = new UserParola(rs.getString("CNP"), rs.getString("idAngajat"));

						Afisare_info_personal q = new Afisare_info_personal(a);
						q.show();
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(LoginResurse.class.getName()).log(java.util.logging.Level.SEVERE, null,
					ex);
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				new LoginResurse().setVisible(true);
			}
		});
	}
