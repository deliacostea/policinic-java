 ...
 * @author Costea Delia
 */
public class Super_Administrator extends javax.swing.JFrame {

	/**
	 * Creates new form Super_Administrator
	 */
	public Super_Administrator() {
		initComponents();
	}
	...
	private void initComponents() {
		...
		jLabel1.setText("Super-Administrator");
				...
				.addGroup(jPanel1Layout.createSequentialGroup().addGroup(jPanel1Layout
						...
						.addGroup(jPanel1Layout.createSequentialGroup().addGap(148, 148, 148)
								.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
										...
										.addComponent(modifica, javax.swing.GroupLayout.PREFERRED_SIZE, 276,
												javax.swing.GroupLayout.PREFERRED_SIZE))))
						.addContainerGap(152, Short.MAX_VALUE)));
		jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel1Layout.createSequentialGroup().addGap(15, 15, 15).addComponent(logout)
						.addGap(33, 33, 33).addComponent(jLabel1).addGap(64, 64, 64).addComponent(modifica,
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(Super_Administrator.class.getName()).log(java.util.logging.Level.SEVERE,
					null, ex);
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				new Super_Administrator().setVisible(true);
			}
		});
	}
